...
plt.savefig('test_aspi_ekfmm_fig1.png',format='png',dpi=300,bbox_inches='tight', pad_inches=0)
plt.savefig('test_aspi_ekfmm_fig1.pdf',format='pdf',dpi=300,bbox_inches='tight', pad_inches=0)
plt.show()
...
plt.colorbar(orientation='horizontal',cax=fig.add_axes([0.37,0.07,0.3,0.02]),shrink=1,label='Traveltime (s)');
plt.savefig('test_aspi_ekfmm_fig1-comp.png',format='png',dpi=300,bbox_inches='tight', pad_inches=0)
plt.show()
